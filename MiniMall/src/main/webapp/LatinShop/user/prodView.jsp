...
<script>
	function goCart(pnum) {
		...
		location.href="03_cartAdd.jsp?pnum="+pnum+"&oqty="+oqty;
	}//goCart
	...
	function goOrder(pnum) {
		...
		oqty = document.myform.oqty.value;
		document.myform.action ="04_toOrder.jsp?pnum="+pnum+"&qoqty="+oqty;
...
<caption><h2><%=pb.getPname() %></h2></caption>
	<tr>
		<td>
			<img src="<%=imgPath %>" width="300" height="300" style="border: 1px solid beige">
		</td>
		<td style="padding-left: 30px;">
			<form name="myform">
				...
				<input type="button" value="checkout" style="padding:5px 15px;" onClick="goOrder(<%=pnum %>)">
				<input type="button" value="Add to Cart" style="padding:5px 15px;" onClick="goCart(<%=pnum%>)">
			</form>
		</td>
	</tr>
	<tr>
	<td style="padding-top: 20px;">
		<font color="blue">Detail of product: </font> <br>
